...
namespace spider2::prometheus
{
    ...
    struct gauge
    {
        ...
        inline explicit operator std::int64_t() const { return value_ptr_->load(); }

        inline std::int64_t increment(std::int64_t value = 1) { return value_ptr_->operator+=(value); }

        inline std::int64_t decrement(std::int64_t value = 1) { return value_ptr_->operator-=(value); }

        inline void set(std::int64_t value = 1) { value_ptr_->operator=(value); }

        inline auto increment_scope(std::int64_t value = 1)
        {
            struct increment_scope
            {
                ~increment_scope() { value_ptr->operator-=(value); }
    ...
    public:
        ...
        inline void observe(T value, std::int64_t count = 1) { value_ptr_->observe(value, count); }
