...
namespace spider2
{
   ...
   struct response
   {
      ...
      auto visit_update(Fun &&updater) -> decltype(updater(const_cast<http::response<http::empty_body> &>(test_obj)))
      {
         ...
         {
            std::visit(overload{[](with_no_response &) -> result_type {}, std::forward<Fun>(updater)}, message);
         }
         else
         {
            ...
            return std::visit(
                overload{[](with_no_response &) -> result_type { return result_type{}; }, std::forward<Fun>(updater)},
                message);
         }
      }
      ...
      auto visit_read(Fun &&visitor) const -> decltype(visitor(test_obj))
      {
         ...
         {
            static_assert(std::is_default_constructible_v<result_type>);
            return std::visit(overload{[](with_no_response const &) -> result_type { return result_type{}; },
      ...
      auto try_get_string_body() const noexcept -> optional<string_view>
      {
         return visit_read(overload{[](http::response<http::string_body> const &msg) -> optional<string_view>
                                    { return {msg.body()}; },
                                    [](auto const &) -> optional<string_view> { return {}; }});
      }
      ...
      {
         return visit_read([](auto const &msg) -> http::fields const * { return &msg; });
      }

      [[nodiscard]] inline auto get_mutable_headers() noexcept -> http::fields *
      {
         return std::visit(overload{[](with_no_response &) -> http::fields * { return nullptr; },
                                    [&](auto &msg) -> http::fields * { return &msg; }},
                           message);
      }

      inline auto try_apply_headers(http::fields const &other) noexcept -> bool
      {
         return std::visit(overload{[](with_no_response &) -> bool { return false; },
                                    [&](auto &msg) -> bool
                                    {
